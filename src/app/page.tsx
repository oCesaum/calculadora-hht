  ...
  return (
    <main className="bg-gradient-to-r from-gray-100 to-gray-300 w-screen min-h-screen grid place-content-center">
      <div className="max-w-xs">
        <h1 className="font-bold text-2xl uppercase text-center mb-10 text-slate-800">Homem Horas Trabalhadas</h1>
      </div>
      <section className="flex flex-col justify-center items-center gap-5">
        <div className="w-72 h-auto bg-white rounded-2xl shadow-xl border-4 border-gray-100">
          <div className="text-gray-700 font-semibold w-auto m-3 text-right space-y-2 py-2">Fórmua: <span className="text-sm">TG = T x 1.000.000 / H</span></div>
